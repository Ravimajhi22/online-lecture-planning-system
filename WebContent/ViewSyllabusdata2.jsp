...
try
{
	...
	ResultSet rs=st.executeQuery("select * from addsyllabus where facultyname='"+userid+"'");
	int count=0;
	out.println("<table class='table table-bordered'>");
	out.println("<tr>"+"<th>"+"Week Day"+"</th>"+"<th>"+"Date Of Class"+"</th>"+"<th>"+"Faculty Id"+"</th>"+"<th>"+"Subject"+"</th>"+"<th>"+"Syllabus"+"</th>"+"<th>"+"Duration"+"</th>"+"<th>"+"Course"+"</th>"+"<th>"+"Stream"+"</th>"+"<th>"+"Year"+"</th>"+"<th>"+"Semister"+"</th>"+"</tr>");
