...
<tr>
<td>
<form action="ViewStudentdata1.jsp" method="post">
 <label class="label-control">Enter Your Course</label>
  ...
  <br>
  <a href="ViewStudentdata1.jsp" class="btn btn-primary btn-block center">View All</a>
  </td>
...
try
{
	...
	out.println("<tr>"+"<th>"+"Id"+"</th>"+"<th>"+"Full Name"+"</th>"+"<th>"+"Email"+"</th>"+"<th>"+"Mobile"+"</th>"+"<th>"+"Course"+"</th>"+"<th>"+"Year"+"</th>"+"<th>"+"Stream"+"</th>"+"<th>"+"User Id"+"</th>"+"<th>"+"Semister"+"</th>"+"<th>"+"Status"+"</tr>");
