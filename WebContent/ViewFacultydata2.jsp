...
try
{
	...
	out.println("<tr>"+"<th>"+"Id"+"</th>"+"<th>"+"Full Name"+"</th>"+"<th>"+"Email"+"</th>"+"<th>"+"Mobile"+"</th>"+"<th>"+"Qualification"+"</th>"+"<th>"+"User Id"+"</th>"+"<th>"+"Update"+"</th>"+"</tr>");
	...
	while(rs.next()) 
	{
		...
		out.println("<td>"+"<a class='btn btn-danger' href='Updatefacultypage.jsp?Id="+rs.getInt(1)+"'>Update</a>"+"</td>");
		out.println("</tr>");
	}
	out.println("</table>");
